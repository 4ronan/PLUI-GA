...
synthesis={
    'vacancy_status':{
        ...
        'reading':'vacance privée non discriminante dans le panel',
        'guardrail':guards['G1_no_relative_excess_private_vacancy']['statement'],
    },
    'vacant_stock_profile':{
        ...
        'reading':'profil des logements vacants non discriminant dans le panel',
        'guardrail':guards['G2_no_atypical_vacant_profile']['statement'],
    },
    'market_context':{
...
out={
    ...
    'headline':{
        ...
        'interpretation':'la vacance privée n’est pas atypique dans le panel; le diagnostic met en évidence des contextes discriminants distincts à examiner sans causalité automatique',
    },
    'synthesis':synthesis,
